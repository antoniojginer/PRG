...
public class MeasuringSortingAlgorithms {
    ...
    public static void measuringSelectionSort() {
        ...
        int[] aux = createArray(100);
        fillRandomArray(aux);
        ti = System.nanoTime();
        MeasurableAlgorithms.selectionSort(aux);
        tf = System.nanoTime();
        tt = (tf - ti);
        
        System.out.println("Talla array " + aux.length);
        System.out.println("Tiempo transcurrido " + tt/NMS + "µs");
