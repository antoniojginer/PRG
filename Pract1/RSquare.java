...
public class RSquare {
    ...
    public static void rSquareA(Graph2D gd, int n, double cX, double cY, double l) {
        ...
        if(n>1){
            rSquareA(gd, n-1, cX - l/2, cY + l/2, l/2);/**Esquina izq arriba*/
            rSquareA(gd, n-1, cX + l/2, cY + l/2, l/2);/**Esquina dcha arriba*/
            rSquareA(gd, n-1, cX - l/2, cY - l/2, l/2);/**Esquina izq abajo*/
            rSquareA(gd, n-1, cX + l/2, cY - l/2, l/2);/**Esquina dcha arriba*/
